<template>
    <div>
        ...
        <form @submit.prevent="addArticle" class="mb-3">
            ...
            <button type="submit" class="btn btn-light btn-block">Publish</button>
        </form>
        ...
        <div class="card card-body mb-3" v-for="article in articles"
...
export default {
    ...
    // the method created runs automatically when the page loads
    created(){
        this.fetchArticles();
    },
